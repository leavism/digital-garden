	...
	return (
		...
		>
			<Link
				href={link}
				target="_blank"
				className="group flex items-center justify-between rounded-sm px-1 py-0.5 underline decoration-1 decoration-gray-300 underline-offset-4"
			>
				<motion.span
					...
					>
						<div className="space-y-6">
							...
							<div className="space-y-3 text-base">
								...
								<p className="font-base text-gray-600 tracking-wide">
						...
						<div className="flex flex-col gap-6 md:flex-row md:gap-10">
							...
							>
								<h2 className="mb-2 font-bold text-xl md:text-2xl">Me</h2>
